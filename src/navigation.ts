...
interface MenuBase {
  id: string;
  label: string;
  /** Intro line at the top of the mega menu. */
  description?: string;
...
export const menus = {
  features: {
    id: 'features',
    label: 'Features',
    description: `Discover how ${site.brand} can empower your business`,
    layout: 'list',
    sections: [
      {
        ...
        items: [
          {
            icon: 'download',
            title: site.product,
            description: `Download the free trial version of the ${site.product}.`,
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            description: `Register the ${site.product} with a subscription license for seamless updates.`,
